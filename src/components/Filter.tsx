...
export function FilterNav({ isOpen, setIsOpen, category, setCategory, price, setPrice }: FilterNavProps) {
    return (
        <>
            <div className="flex p-4 border-t border-b gap-x-4 items-center">
                ...
                <div><input type="number" name="price" id="price" placeholder="Price" className="appearance-none p-1 border" value={price} onChange={(e) => setPrice(parseInt(e.target.value))} /></div>
